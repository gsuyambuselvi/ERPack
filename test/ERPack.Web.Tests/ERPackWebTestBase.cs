...
{
    public abstract class ERPackWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ERPackWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ERPackWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ERPackDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ERPackDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ERPackDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ERPackDbContext, Task<T>> func)
        {
            T result;
